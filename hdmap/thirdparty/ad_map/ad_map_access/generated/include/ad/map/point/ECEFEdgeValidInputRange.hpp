 ...
 */
inline bool withinValidInputRange(::ad::map::point::ECEFEdge const &input, bool const logErrors = true)
{
  ...
  if (inValidInputRange)
  {
    for (auto const &member : input)
    {
      ...
      {
        spdlog::error("withinValidInputRange(::ad::map::point::ECEFEdge)>> {}, invalid member {}",
                      input,
