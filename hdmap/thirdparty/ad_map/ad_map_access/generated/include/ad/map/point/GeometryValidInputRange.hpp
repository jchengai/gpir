...
/*!
 * \brief check if the given Geometry is within valid input range
 *
 * \param[in] input the Geometry as an input value
 * \param[in] logErrors enables error logging
 *
 * \returns \c true if Geometry is considered to be within the specified input range
 *
 * \note the specified input range is defined by the ranges of all members
 */
inline bool withinValidInputRange(::ad::map::point::Geometry const &input, bool const logErrors = true)
{
