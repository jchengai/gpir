 ...
 *
 * Defines a list of map matched positions ordered by probability in decreasing
 * order
 */
typedef std::vector<::ad::map::match::MapMatchedPosition>
...
inline std::ostream &operator<<(
    std::ostream &os,
    vector<::ad::map::match::MapMatchedPosition> const &_value) {
  os << "[";
...
inline std::string to_string(
    ::ad::map::match::MapMatchedPositionConfidenceList const &value) {
